...
export const EVIDENCE_CLAIMS: readonly EvidenceClaim[] = [
  {
    ...
    limitations:
      'Literature supports a positive dose-response and often a ≥10 lower region; it does not cleanly underwrite a discrete upper bound of 20. Certified keeps 10–20 as a stable product default so existing personal training against that band is not silently rewritten. Personal targets override it.',
  ...
  },
  {
    ...
    support: 'partial',
    interpretation:
      'Pelland 2026 finds fractional counting of indirect sets (0.5) fits dose-response data better than counting every indirect set as a full set. Certified’s default 0.5 matches that spirit for credited-set accounting, and remains user-editable.',
    limitations:
  ...
  },
  {
    ...
    support: 'partial',
    interpretation:
      'High-rep sets are useful training data but make 1RM estimates too noisy to show as strength. Brzycki’s chart was aimed at lower-rep fatigue sets; Certified hard-caps at 12.',
    limitations:
  ...
  },
  {
    ...
    statement:
      'Training near failure can matter for hypertrophy, but Certified does not currently prescribe an RIR target.',
    kind: 'implementation_heuristic',
