    ...
    return (
      <>
        ...
        <EmptyState
          ...
          description="Analytics are computed from your logged sets. Finish a session — or import your Strong history — and every chart here fills in."
          icon="📈"
          action={
          ...
          actions={
            <>
              ...
              <Button
                size="sm"
                variant="ghost"
                onClick={() => setHelp({ title: 'How volume is calculated', lines: VOLUME_HELP })}
              >
                ?
              </Button>
            </>
                    ...
                    <th scope="row" className="py-1.5 font-normal text-ink">
                      <span className="flex items-center gap-2">
                        <span
                          ...
                          style={{ width: `${Math.max(4, (row.attributedVolumeG / max) * 64)}px` }}
                        />
          ...
          <ChartCard
            ...
            actions={
              <Button
                size="sm"
                variant="ghost"
                onClick={() => setHelp({ title: 'Estimated 1RM', lines: oneRepMaxHelp(formula) })}
              >
                ?
              </Button>
            }
